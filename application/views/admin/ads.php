...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1>Ads <small> For pages.</small></h1>
                <!--                <ol class="breadcrumb">-->
...
";
                ...
                $lm->identity_name = 'AdID';


                // optional, define grid sort order
                $lm->grid_default_order_by = 'AdID desc';


                // optional, make friendly names for fields
                $lm->rename = array('AdID' => 'ID');


                // optional, define input controls on the form
                $lm->form_input_control = array('photo' => '--image', 'IsActive' => '--checkbox', 'country_id' => 'select country_id, country_name from country; --select', 'AdTypeID' => 'select AdTypeID, Name from AdType; --select','SectionID' => 'select SectionID, Name from Sections; --select','PageID' => 'select PageID, Name from Pages; --select');


                // optional, define editable input controls on the grid
                $lm->grid_input_control = array('IsActive' => '--checkbox', 'AdTypeID' => 'select AdTypeID, Name from AdType; --select','SectionID' => 'select SectionID, Name from Sections; --select','PageID' => 'select PageID, Name from Pages; --select');


                // optional, define output control on the grid; make email clickable and the photo a clickable link
                $lm->grid_output_control = array('contact_email' => '--email', 'photo' => '--image', 'AdTypeID' => 'select AdTypeID, Name from AdType; --select');
