...
";
                ...
                $lm->identity_name = 'QuestionID';


                // optional, define grid sort order
                $lm->grid_default_order_by = 'QuestionID desc';


                // optional, make friendly names for fields
                $lm->rename = array('QuestionID' => 'ID');


                // optional, define input controls on the form
                $lm->form_input_control = array('Question' => '--textarea', 'AnswerExplanation' => '--textarea', 'IsActive' => '--checkbox', 'Answer' => 'select Description,Value  from AnswerOptions; --select', 'Date' => '--datetime', 'UserID' => 'select UserID,Username  from Users; --select', 'CategoryID' => 'select CategoryID,Name  from Categories; --select');


                // optional, define editable input controls on the grid
                $lm->grid_input_control = array('IsActive' => '--checkbox');
