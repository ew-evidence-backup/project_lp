...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1>Email Preferences <small> For Users.</small></h1>
                <!--                <ol class="breadcrumb">-->
...
";
                ...
                $lm->table = 'EmailPreferences';


                // identity / primary key for table
                $lm->identity_name = 'EmailPreferenceID';


                // optional, define grid sort order
                $lm->grid_default_order_by = 'EmailPreferenceID desc';


                // optional, make friendly names for fields
                $lm->rename = array('EmailPreferenceID' => 'ID');

                //FOR FORM
                // optional, define input controls on the form
                $lm->form_input_control = array('Image' => '--image', 'IsActive' => '--checkbox', 'country_id' => 'select country_id, country_name from country; --select','News'=>'--checkbox','Teams'=>'--checkbox','Scores'=>'--checkbox','UserID'=> 'select UserID, Username from Users; --select','CategoryID'=> 'select CategoryID, Name from Categories; --select','EmailIntervalID'=> 'select EmailIntervalID, Name from EmailIntervals; --select');

                //FOR GRID
                // optional, define editable input controls on the grid
                $lm->grid_input_control = array('IsActive' => '--checkbox','UserID'=> 'select UserID, Username from Users; --select','News'=>'--checkbox','Teams'=>'--checkbox','Scores'=>'--checkbox','CategoryID'=> 'select CategoryID, Name from Categories; --select','EmailIntervalID'=> 'select EmailIntervalID, Name from EmailIntervals; --select');

                //FOR OUTPUT GRID
                // optional, define output control on the grid; make email clickable and the photo a clickable link
                $lm->grid_output_control = array('Image' => '--image');
