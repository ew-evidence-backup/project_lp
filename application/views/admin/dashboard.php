...
<head>
    ...
    <title>Dashboard - InboxTrivia.com</title>
...
<!--        </ol>-->
        <div class="alert alert-success alert-dismissable">
            ...
            Welcome to <b>InboxTrivia's</b> Administration Dashboard! If you have any questions please feel free to read out
            <a href="#">documentation file</a>.
        </div>
    </div>
</div>
<!-- /.row -->
...
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-bar-chart-o"></i> Traffic Statistics: October 1, 2013 - October
                    31, 2013</h3>
            </div>
...
<div class="row">
    <div class="col-lg-4">
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-long-arrow-right"></i> Traffic Sources: October 1, 2013 -
                    October 31, 2013</h3>
            </div>
            <div class="panel-body">
