...
";
                ...
                $lm->form_input_control = array('photo' => '--image', 'IsActive' => '--checkbox', 'Password'=>'--password', 'Type' => 'select Value, Name from UserTypes; --select','Avatar' => '--image');


                // optional, define editable input controls on the grid
                $lm->grid_input_control = array('IsActive' => '--checkbox','photo' => '--image');


                // optional, define output control on the grid; make email clickable and the photo a clickable link
                $lm->grid_output_control = array('Email' => '--email', 'Avatar' => '--image','Password'=>'');
