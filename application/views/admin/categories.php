...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1>Categories <small> For questions.</small></h1>
                <!--                <ol class="breadcrumb">-->
...
";
                ...
                $lm->identity_name = 'CategoryID';


                // optional, define grid sort order
                $lm->grid_default_order_by = 'CategoryID desc';


                // optional, make friendly names for fields
                $lm->rename = array('CategoryID' => 'ID');


                // optional, define input controls on the form
                $lm->form_input_control = array('Image' => '--image', 'is_active' => '--checkbox', 'country_id' => 'select country_id, country_name from country; --select');
