...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1>Reports <small> Site wide.</small></h1>
                <!--                <ol class="breadcrumb">-->
...
";
                ...
                $lm->form_input_control = array('Image' => '--image', 'IsActive' => '--checkbox','UserID'=> 'select UserID, Username from Users; --select');


                // optional, define editable input controls on the grid
                $lm->grid_input_control = array('IsActive' => '--checkbox','UserID'=> 'select UserID, Username from Users; --select');
